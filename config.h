...
static Key keys[] = {
	...
	STACKKEYS(MODKEY,                          focus)
		...
		{ MODKEY,			XK_semicolon,	spawn,	SHCMD("dmenuunicode") },
	/* { MODKEY|ShiftMask,		XK_semicolon,	togglescratch,	SHCMD("") }, */
	TAGKEYS(			XK_plus,		0)
		TAGKEYS(			XK_ecaron,		1)
		TAGKEYS(			XK_scaron,		2)
		TAGKEYS(			XK_ccaron,		3)
		...
		{ MODKEY,			XK_equal,	spawn,		SHCMD("pamixer --allow-boost -d 5; kill -44 $(pidof dwmblocks)") },
		{ MODKEY|ShiftMask,		XK_equal,	spawn,		SHCMD("pamixer --allow-boost -d 15; kill -44 $(pidof dwmblocks)") },
		{ MODKEY,			XK_dead_acute,	spawn,		SHCMD("pamixer --allow-boost -i 5; kill -44 $(pidof dwmblocks)") },
		{ MODKEY|ShiftMask,		XK_dead_acute,	spawn,		SHCMD("pamixer --allow-boost -i 15; kill -44 $(pidof dwmblocks)") },
		...
		{ MODKEY,			XK_z,		setlayout,	{.v = &layouts[3]} }, /* spiral */
		{ MODKEY|ShiftMask,		XK_z,		setlayout,	{.v = &layouts[4]} }, /* dwindle */
		...
		{ MODKEY,			XK_i,		spawn,		SHCMD("emacsclient -c -a 'Emacs'") },
		{ MODKEY|ShiftMask,		XK_i,		setlayout,	{.v = &layouts[7]} }, /* centeredfloatingmaster */
		/* { MODKEY,			XK_o,		incnmaster,     {.i = +1 } }, */
		{ MODKEY,			XK_o,		spawn,			SHCMD("comptoggle") },
		{ MODKEY|ShiftMask,		XK_o,		incnmaster,     {.i = -1 } },
		{ MODKEY,			XK_p,			spawn,		SHCMD("mpc toggle") },
		{ MODKEY|ShiftMask,		XK_p,			spawn,		SHCMD("mpc pause ; pauseallmpv") },
		{ MODKEY,			XK_uacute,		spawn,		SHCMD("mpc seek -10") },
		{ MODKEY|ShiftMask,		XK_uacute,		spawn,		SHCMD("mpc seek -60") },
		{ MODKEY,			XK_parenright,	spawn,		SHCMD("mpc seek +10") },
		{ MODKEY|ShiftMask,		XK_parenright,	spawn,		SHCMD("mpc seek +60") },
		{ MODKEY,			XK_dead_diaeresis,		view,		{0} },
		/* { MODKEY|ShiftMask,		XK_dead_diaeresis,		spawn,		SHCMD("") }, */
...
{ MODKEY,			XK_uring,	shiftview,	{ .i = 1 } },
{ MODKEY|ShiftMask,		XK_uring,	shifttag,	{ .i = 1 } },
{ MODKEY,			XK_section,	togglescratch,	{.ui = 1} },
	/* { MODKEY|ShiftMask,		XK_section,	spawn,		SHCMD("") }, */
